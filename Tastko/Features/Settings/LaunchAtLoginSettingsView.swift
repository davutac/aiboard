...
struct LaunchAtLoginSettingsView: View {
    ...
    var body: some View {
        Section("Startup") {
            ...
            if preloginInstalled {
                Text(
                    "Tastko is also installed for the Mac login window. Reinstall to refresh its copy of your home keyboard."
                )
                .font(.callout)
                .foregroundStyle(.secondary)
    ...
    private func refreshStatus() {
        ...
        preloginInstalled = FileManager.default.fileExists(
            atPath: "/Library/LaunchAgents/com.davutcaliskan.Tastko.LoginWindow.plist"
        )
        Logger(subsystem: "com.davutcaliskan.Tastko", category: "LaunchAtLogin")
