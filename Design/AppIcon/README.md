...
Generated with the built-in imagegen tool. Thirteen larger keys replace the original thirty-one. The compact foreground is composed at 75% scale to fill more of the frame; the charcoal background is unchanged. The previous foreground is preserved as `keyboard-charcoal-v1.png`.

Generate a transparent PNG foreground asset for a macOS icon, using a REAL alpha channel. This must be an RGBA cutout, not an RGB picture of a checkerboard.
A compact nearly square charcoal keyboard with exactly thirteen keys. Five large colorful square shortcut keys across the top, colored red, pink, cyan, green and yellow. Two rows of three large dark graphite keycaps beneath. Bottom row: one small graphite key and a wide graphite spacebar. Thick, softly rounded black chassis and precise, softly sculpted edges. Premium dark macOS keyboard finish. Straight front view, minimal top-down perspective. No text or symbols on the keys. No background tile. No exterior shadow, glow, or floor.
Keyboard body approximately 1.1 times as wide as tall, centered and occupying 85 percent of the square image. Transparent space around all four sides. Return actual transparent PNG, absolutely no painted checkerboard.
...
Style/medium: premium restrained macOS icon artwork, satin ceramic body with gently sculpted keycaps, precise edges, minimal fine detail.
Composition/framing: square 1024x1024 canvas. Center the complete keyboard, approximately 760 pixels wide and 510 pixels high, with ample transparent padding. Symmetric and balanced.
Materials/textures: neutral pearly white and soft silver, restrained shading for dimensionality, no baked-in exterior drop shadow; Icon Composer will add the glass and lighting.
Constraints: output only the keyboard foreground on real transparency; no text, no letters, no watermark, no scenery, no outer squircle, no checkerboard baked into pixels.
