...
1. [Download the latest release](https://github.com/davutac/aiboard/releases/latest), open the DMG, and drag Aiboard into Applications.
2. Open Aiboard and allow it in System Settings → Privacy & Security → Accessibility.
3. Open Panel Editor from Aiboard's panel menu, save a keyboard, and reload profiles.
...
Requires Xcode with the macOS 27 SDK or later. Open `Aiboard.xcodeproj`, or run from the repository root:
...
Keyboard sounds from [tplai/kbsim](https://github.com/tplai/kbsim), used under the [MIT license](Aiboard/Resources/KeyboardSounds/LICENSE-kbsim.txt).
